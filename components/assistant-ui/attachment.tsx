...
export const ComposerAddAttachment: FC = () => {
  ...
  const takeScreenshot = async () => {
    try {
      ...
      // User cancelled screen capture or unsupported
    }
  };
        ...
        <Menu.Trigger
          render={
            <Button
              variant="ghost"
              size="icon"
              className="aui-composer-add-attachment hover:bg-muted/60 size-7 rounded-full"
              aria-label="Add"
            />
          }
        >
          <PlusIcon className="aui-attachment-add-icon size-3.5 stroke-[1.5px]" />
        </Menu.Trigger>
        <Menu.Portal>
          <Menu.Positioner
            side="top"
          ...
          >
            <Menu.Popup className="bg-popover text-popover-foreground border-border/50 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 min-w-48 origin-(--transform-origin) overflow-hidden rounded-xl border p-1 shadow-lg">
              <Menu.Item
              ...
              >
                ...
                <kbd className="text-muted-foreground font-sans text-[11px] tracking-wide">
                  ⌘U
                </kbd>
              </Menu.Item>
              <Menu.Item
              ...
              >
                <CameraIcon className="size-3.5 shrink-0 opacity-70" />
